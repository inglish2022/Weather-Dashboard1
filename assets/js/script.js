...
var day2Desc = document.getElementById('day1Desc');
...
var day3Desc = document.getElementById('day2Desc');
...
var day4Desc = document.getElementById('day3Desc');
...
var day5Desc = document.getElementById('day4Desc');
...
function oneCall(lat, lon) {
    ...
    fetch(apiURL)
        ...
        .then(function (data) {
            ...
            day1Desc.textContent = data.daily[1].weather[0].description;
            ...
            day2Desc.textContent = data.daily[2].weather[0].description;
            ...
            day3Desc.textContent = data.daily[3].weather[0].description;
            ...
            day4Desc.textContent = data.daily[4].weather[0].description;
            ...
            day5Desc.textContent = data.daily[5].weather[0].description;
